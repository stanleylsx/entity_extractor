...
class GeneralDistiller(BasicDistiller):
    ...
    def __init__(self, logger,
        ...
        super(GeneralDistiller, self).__init__(logger, train_config, distill_config, model_T, model_S,
                                               adaptor_T, adaptor_S)
    ...
    def save_and_callback(self, global_step, step, epoch, val_dataloader, callback):
        ...
        super(GeneralDistiller, self).save_and_callback(global_step, step, epoch, val_dataloader, callback)
